          ...
          <div className="space-y-12 text-gray-600 leading-relaxed">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 flex flex-col md:flex-row gap-6 items-start">
                <div className="bg-[#1E293B] p-4 rounded-2xl shrink-0">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#C69C2D] shrink-0 mt-0.5" /> <span><strong>Dokumen Identitas:</strong> KTP, KK, dan Buku Nikah (bagi suami istri).</span></li>
            ...
            <div className="bg-[#1E293B] p-8 rounded-3xl text-center shadow-lg mt-12">
            ...
            <div className="text-center mt-12">
              <h3 className="text-2xl font-bold text-[#1E293B] mb-4">Butuh Panduan Lebih Detail?</h3>
              ...
              <Link 
                to="/contact" 
                className="inline-block bg-[#C69C2D] hover:bg-[#A88222] text-white font-bold py-4 px-8 rounded-full transition-colors shadow-lg"
              >
