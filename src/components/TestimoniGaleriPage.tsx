      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-[#003366] mb-4">Testimoni & Galeri</h1>
            <h2 className="text-2xl font-semibold text-[#0056B3] mb-6">Jejak Syukur di Tanah Suci</h2>
          ...
          <div className="space-y-12 text-gray-600 leading-relaxed">
            ...
            {/* Testimonials */}
            <div>
              <h3 className="text-3xl font-bold text-[#003366] mb-2 text-center">Apa Kata Mereka?</h3>
              <p className="text-center text-[#0056B3] font-medium mb-10">Suara Jamaah, Kebanggaan Kami.</p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-[#E6F0FA] p-8 rounded-3xl border border-gray-100 relative">
                  <Quote className="w-12 h-12 text-[#0056B3]/20 absolute top-6 left-6" />
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#003366]">Ibu Rahmawati</h4>
                ...
                <div className="bg-[#E6F0FA] p-8 rounded-3xl border border-gray-100 relative">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#003366]">Bapak Aris</h4>
            ...
            <div className="pt-12 border-t border-gray-100">
              <h3 className="text-3xl font-bold text-[#003366] mb-2 text-center">Galeri Keberangkatan & Kegiatan</h3>
              <p className="text-center text-[#0056B3] font-medium mb-10">Melihat Lebih Dekat, Melangkah Lebih Mantap.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="group relative overflow-hidden rounded-3xl shadow-sm border border-gray-100 aspect-video bg-gray-200">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#003366]/80 via-transparent to-transparent flex flex-col justify-end p-6">
