  ...
  return (
    <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-8 flex flex-col h-full border border-gray-100 hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
      ...
      <div className="text-center mb-8 mt-4">
        <h3 className="text-2xl font-bold text-[#003366] mb-2 leading-tight min-h-[64px] flex flex-col items-center justify-center whitespace-pre-wrap">
          {title}
        </h3>
        <p className="text-sm text-gray-500 mb-1">{subtitle}</p>
        <p className="text-4xl font-bold text-[#0056B3]">{price}</p>
      </div>

      {/* Features List */}
      <div className="flex-grow space-y-4 mb-8">
        <div className="flex items-start gap-3">
          <Clock className="w-5 h-5 text-[#0056B3] shrink-0 mt-0.5" />
          <span className="text-gray-700 text-sm">Durasi: {duration}</span>
        </div>
        <div className="flex items-start gap-3">
          <Calendar className="w-5 h-5 text-[#0056B3] shrink-0 mt-0.5" />
          <span className="text-gray-700 text-sm">Jadwal: {schedule}</span>
        </div>
        <div className="flex items-start gap-3">
          <Plane className="w-5 h-5 text-[#0056B3] shrink-0 mt-0.5" />
          <span className="text-gray-700 text-sm">{flight}</span>
        </div>
        <div className="flex items-start gap-3">
          <Building2 className="w-5 h-5 text-[#0056B3] shrink-0 mt-0.5" />
        ...
        <div className="flex items-start gap-3">
          <Star className="w-5 h-5 text-[#0056B3] shrink-0 mt-0.5" />
          <div className="flex items-center gap-1 text-sm text-gray-700">
            Kelas Hotel: 
            <div className="flex text-[#0056B3] ml-1">
              {[...Array(5)].map((_, i) => (
        ...
        <div className="flex items-start gap-3">
          <Gift className="w-5 h-5 text-[#0056B3] shrink-0 mt-0.5" />
      ...
      <a
        ...
        className="w-full bg-[#0056B3] hover:bg-[#004494] text-white font-bold py-3.5 px-4 rounded-full flex items-center justify-center gap-2 transition-colors duration-300"
      >
