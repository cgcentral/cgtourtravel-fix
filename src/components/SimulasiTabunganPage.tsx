      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl font-semibold text-[#dfa828] mb-6">Rencanakan Keberangkatan Anda</h2>
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-medium">Rp</span>
                    ...
                    className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#dfa828] focus:border-transparent outline-none transition-all font-medium text-[#1E293B]" 
                  />
                </div>
                  ...
                  {[3, 4, 6, 12].map((bulan) => (
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl font-bold transition-all border-2 ${
                        durasiBulan === bulan 
                          ? 'bg-[#dfa828] border-[#dfa828] text-white shadow-md scale-[1.02]' 
                          : 'bg-white border-gray-100 text-gray-600 hover:border-[#dfa828]/30'
                      }`}
                    >
                      {bulan} Bulan
                    </button>
            ...
            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 flex flex-col justify-center relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <span className="block text-3xl font-bold text-[#dfa828]">{formatRupiah(setoranPerBulan)}</span>
              ...
              <div className="mt-8 relative z-10">
                <a 
                  href={`https://wa.me/6282312313640?text=Halo%20CG%20Tour%20Travel,%20saya%20tertarik%20dengan%20program%20Tabungan%20Umroh.%20Target%20paket%20${formatRupiah(targetDana)},%20DP%20${formatRupiah(danaAwal)},%20rencana%20menabung%20${durasiBulan}%20bulan.%20Mohon%20infonya.`}
                  target="_blank"
