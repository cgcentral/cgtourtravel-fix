...
const packages = [
  ...
  },
  {
    title: (
      <>
        Umroh Mister Catur
        <span className="block text-lg text-[#0056B3] italic mt-1 font-semibold">Coming Soon</span>
      </>
    ),
    price: "Rp 30 Jutaan",
    duration: "9 Hari",
    ...
    <section id="paket" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#003366] mb-4">Pilihan Paket Keberangkatan</h2>
        ...
        <div className="bg-white p-4 rounded-2xl shadow-sm mb-12 flex flex-col md:flex-row gap-4 justify-center items-center max-w-4xl mx-auto border border-gray-100">
          <select className="w-full md:w-auto px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#0056B3] text-gray-600">
          ...
          <button className="w-full md:w-auto bg-[#0056B3] text-white px-8 py-2 rounded-lg hover:bg-[#004494] transition-colors">
            Cari Paket
          </button>
        </div>
